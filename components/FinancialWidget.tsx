...
const FinancialWidget: React.FC<FinancialWidgetProps> = ({ userData, onOpen }) => {
    ...
    const monthlySummary = useMemo(() => {
        ...
        return { income, expenses, balance, budgetUsage, totalBudget };
        ...
        >
            <div>
                <div className="flex justify-between items-center mb-2">
                    <h3 className="font-bold text-green-300">خلاصه مالی ماه</h3>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center text-base mt-2 pt-2 border-t border-slate-700">
                        <span className="text-slate-300 font-semibold">موجودی:</span>
                        <span className={`font-bold ${monthlySummary.balance >= 0 ? 'text-white' : 'text-red-400'}`}>
                            {formatCurrency(monthlySummary.balance)} تومان
                        </span>
                    </div>
                </div>
            </div>
